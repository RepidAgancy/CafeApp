...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'common.context_processor.get_languages',
            ],
        },
    },
]
...
MEDIA_URL = 'https://api.repid.uz/media/'
...
JAZZMIN_SETTINGS = {
    "site_title": "Restuarant Admin",
    "site_header": "Restuarant",
    "site_brand": "Restuarant",
    "site_logo": None,
    "login_logo": None,
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'redis://127.0.0.1:6379/1',  # Redis serveri manzili
        'OPTIONS': {
